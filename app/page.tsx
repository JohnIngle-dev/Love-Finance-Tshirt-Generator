...
export default function Page() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(1200px 800px at 10% -10%, rgba(239,68,68,0.3), transparent 45%), radial-gradient(900px 600px at 110% -20%, rgba(139,92,246,0.28), transparent 50%), linear-gradient(180deg, #09090b 0%, #09090b 100%)",
      }}
    >
      {/* noise overlay */}
      <div
      ...
      <header className="sticky top-0 z-10 border-b border-white/10 bg-black/50 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 py-5 flex items-center">
          <div className="flex items-center gap-4">
            <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-red-600/80 to-fuchsia-700/80 ring-1 ring-white/15 shadow-[0_4px_18px_rgba(239,68,68,0.35)]" />
      ...
      <main className="mx-auto max-w-6xl px-6 py-10 md:py-14">
        {/* HERO GRID: form left, result right */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Form card */}
          <section className="rounded-2xl ring-1 ring-white/10 bg-gradient-to-b from-zinc-900/80 to-black/70 shadow-[0_15px_50px_rgba(0,0,0,0.45)] p-6 md:p-8">
            <h2 className={`${gothic.className} text-4xl md:text-5xl tracking-wide mb-6`}>
              T-Shirt Generator
            </h2>
            ...
            <form onSubmit={getOptions} className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="group inline-flex items-center gap-3 rounded-2xl px-6 py-3.5 text-base md:text-lg font-semibold tracking-wide text-white
                  bg-[linear-gradient(180deg,rgba(239,68,68,0.98),rgba(190,24,93,0.98))]
                  hover:bg-[linear-gradient(180deg,rgba(239,68,68,1),rgba(190,24,93,1))]
                  ring-1 ring-white/15 shadow-[0_12px_30px_rgba(239,68,68,0.35)]
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-2xl px-6 py-3.5 text-base md:text-lg font-medium
            ...
            {/* Error notice under form */}
            {err && (
              <div className="mt-5 rounded-xl border border-red-500/40 bg-red-600/10 px-4 py-3 text-sm text-red-200">
                {err}
              </div>
            )}
          </section>

          {/* Right column: options or result */}
          <section className="space-y-6">
              ...
              <div className="grid gap-5">
                {options.map((o, i) => (
                  <button
                    ...
                    disabled={rendering}
                    className="group text-left rounded-2xl bg-zinc-950/85 border border-zinc-800/70 hover:border-red-500/60 hover:shadow-[0_15px_40px_rgba(239,68,68,0.2)] transition
                    p-6 ring-1 ring-white/5"
                  >
                    <div className={`${gothic.className} text-3xl tracking-wide`}>
                      {o.slogan}
                    </div>
            ...
            {/* Result */}
            {rendered && (
              <div className="rounded-2xl ring-1 ring-white/10 bg-gradient-to-b from-zinc-900/80 to-black/70 shadow-[0_15px_50px_rgba(0,0,0,0.45)] p-6 md:p-8 space-y-6">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <h3 className={`${gothic.className} text-3xl tracking-wide`}>
                      Generated design
                    </h3>
                  ...
                  <button
                    ...
                    className="group inline-flex items-center gap-3 rounded-2xl px-5 py-3 text-sm md:text-base font-semibold tracking-wide text-white
                    bg-[linear-gradient(180deg,rgba(244,63,94,0.98),rgba(147,51,234,0.98))]
                    hover:bg-[linear-gradient(180deg,rgba(244,63,94,1),rgba(147,51,234,1))]
